...
public class Feedback {
    ...
    public Feedback(Integer id, String name, String feedbackMessage, String topicId) {
        this.id = id;
        this.name = name;
    ...
    public Feedback(String name, String feedbackMessage, String topicId) {
        this.name = name;
        this.feedbackMessage = feedbackMessage;
    ...
    private void createNewTopic(String topicId) {
